                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                <b>Group Name : </b><?php echo $groups[$i]['name']?><br><br><br>
                             <!--   <b>Votes :</b> <?php echo $groups[$i]['votes']?><br><br>  -->
                                ...
                                if($_SESSION['status']==1){
                                    ?>
                                    <button disabled style="padding: 5px; font-size: 15px; background-color: #398AB9; color: white; border-radius: 5px;" type="button">Voted</button>
                                    <?php
                                }
                                else{
                                    ?>
                                    <button style="padding: 5px; font-size: 15px; background-color: #398AB9; color: white; border-radius: 5px;" type="submit">Vote</button>
                                    <?php
                                }
                                ?>
                                </form>
